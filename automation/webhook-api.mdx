...
If you want deeper customization beyond no-code blocks, Nicecall supports **webhooks** and a **REST API**.

## 1. Webhooks

- **When to Use**: Trigger events in external systems the moment something happens in Nicecall (e.g., "Call Ended,").
...
**Note:** You'll find the official API reference in a dedicated docs section or via your Nicecall dashboard. Always secure your tokens and test endpoints in a dev environment.
