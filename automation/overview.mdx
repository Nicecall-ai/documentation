...
description: "Learn about Nicecall's built-in automation engine for creating workflows without coding"
---
...
Nicecall includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside Nicecall (e.g., "call ended," "inbound call context injection").
