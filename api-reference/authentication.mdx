...
The Nicecall API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your Nicecall account at [https://app.nicecall.ai](https://app.nicecall.ai)
...
```bash
curl -X GET "https://app.nicecall.ai/api/user/campaigns" \
